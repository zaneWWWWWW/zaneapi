...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"data_export_last_success_at":   model.GetLastQuotaDataExportAt(),
		...
		"home_page_group_ratios":      setting.BuildHomePageGroupRatios(common.OptionMap["HomePageDisplayedGroups"]),
	}
...
func GetAbout(c *gin.Context) {
	...
	for _, key := range []string{"About", "AboutCommitments", "AboutContact"} {
		if v := strings.TrimSpace(common.OptionMap[key]); v != "" {
