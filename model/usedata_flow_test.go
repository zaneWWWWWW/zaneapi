...
func TestGetFlowQuotaDataUsesQuotaDataRoleSpecificDimensions(t *testing.T) {
	...
	rootRows, err := GetFlowQuotaData(900, 2000, "", 0, common.RoleRootUser, DataScope{All: true})
	...
	adminRows, err := GetFlowQuotaData(900, 2000, "alice", 0, common.RoleAdminUser, DataScope{All: true})
	require.NoError(t, err)
	...
	selfRows, err := GetFlowQuotaData(900, 2000, "", 1, common.RoleCommonUser, DataScope{All: true})
	require.NoError(t, err)
