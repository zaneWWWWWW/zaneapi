...
import { APP_SIDEBAR_METRICS } from '@/components/layout/constants'
...
const SIDEBAR_WIDTH = APP_SIDEBAR_METRICS.desktopWidth
const SIDEBAR_WIDTH_MOBILE = APP_SIDEBAR_METRICS.mobileWidth
const SIDEBAR_WIDTH_ICON = APP_SIDEBAR_METRICS.collapsedWidth
...
function SidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
  return (
    <main
      ...
      className={cn(
        'bg-background relative flex w-full flex-1 flex-col md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-lg md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2',
        className
      )}
      {...props}
    />
