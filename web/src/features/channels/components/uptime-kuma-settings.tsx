...
export function UptimeKumaSettings(props: UptimeKumaSettingsProps) {
  ...
  const handleToggleEnabled = async (checked: boolean) => {
    try {
      ...
      await queryClient.invalidateQueries({ queryKey: ['uptime-kuma-status'] })
